...
WebUI.click(findTestObject('Object Repository/Bank 1/Page_Home - BankSystem/Login'))
...
if (WebUI.verifyTextPresent('The Email field is required.', false, FailureHandling.OPTIONAL) == true) {
		...
		WebUI.setText(findTestObject('Object Repository/Bank 1/Page_Log in - BankSystem/Email'), email2)
		...
		WebUI.setText(findTestObject('Object Repository/Bank 1/Page_Log in - BankSystem/Password'), pass2)
...
WebUI.click(findTestObject('Object Repository/Bank 1/Page_Home Page - BankSystem/button_Close'))
